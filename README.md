...
**ATIVO** | armazenará um boleano que por padrão será True para novos clientes e poderá ser mudado pelo Administrador para False inativando a conta(moderação) e false para novos fornecedores, que dependerão da aprovação d o Admin para serem ativados;
**NOME** | armazenará o Nome do usuário inserido durante o cadastro;
**DOCUMENTO** | armazenará o número do CNPJ para Fornecedores, opcionalmente o CPF para Clientes, (ou outro documento para futuros novos tipos de cadastro ex: Nutricionista);
**TELEFONE** | armazenará número de telefone inserido no cadastro;
...
**MARCA** | armazenará a marca do produto;
...
**COD_RESTRICAO** | é uma foreign key de RESTRIÇÃO;
